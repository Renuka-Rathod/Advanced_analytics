Factor_Analysis_Delta_Cars <- read_excel("C:/Users/Renuka/OneDrive/Documents/IACSD/Advanced_analytics/Advance Analytics-2024/Day-11_EFA & Cluster Analysis/EFA/Factor Analysis_Delta Cars.xlsx")
